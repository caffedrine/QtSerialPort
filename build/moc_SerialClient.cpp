...
QT_MOC_LITERAL(3, 24, 23), // "connectionStatusChanged"
QT_MOC_LITERAL(4, 48, 9), // "connected"
QT_MOC_LITERAL(5, 58, 28), // "QSerialPort::SerialPortError"
QT_MOC_LITERAL(6, 87, 5) // "errNo"

    },
    "SerialClient\0readyRead\0\0connectionStatusChanged\0"
    "connected\0QSerialPort::SerialPortError\0"
    "errNo"
};
...
void SerialClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->connectionStatusChanged((*reinterpret_cast< QSerialPort::SerialPortError(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (SerialClient::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SerialClient::readyRead)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (SerialClient::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SerialClient::connectionStatusChanged)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject SerialClient::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SerialClient.data,
...
void *SerialClient::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SerialClient.stringdata0))
        return static_cast<void*>(const_cast< SerialClient*>(this));
...
// SIGNAL 1
void SerialClient::connectionStatusChanged(bool _t1)
{
